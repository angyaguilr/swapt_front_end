from .models import CmntyListing,ProductAttribute
from django.db.models import Min,Max
def get_filters(request):
	cats=CmntyListing.objects.distinct().values('category__title','category__id')
	brands=CmntyListing.objects.distinct().values('brand__title','brand__id')
